...
namespace FakeMicro.DatabaseAccess.Repositories
{
    ...
    /// </summary>
    public class NoteTagRepository : MongoRepository<NoteTag, Guid>, INoteTagRepository
    {
        private readonly ILogger<NoteTagRepository> _logger;
        ...
        public NoteTagRepository(
            MongoClient mongoClient,
            ILogger<NoteTagRepository> logger,
